  ...
  return (
    // <Animation>
      <main className='flex h-screen flex-col items-center justify-between bg-offwhite-color'>
        ...
        {/* Hero Section */}
        <section className='flex h-screen w-full flex-wrap items-center justify-center bg-offwhite-color'>
          <div className='container mx-auto flex flex-wrap px-10 md:h-full lg:px-24 xl:px-32'>
            <div className='z-1 relative w-full md:w-2/4'>
              <div className='flex h-full w-full flex-col items-center justify-center space-y-6 text-center text-mytext-color md:items-start md:text-left'>
                <h1 className='text-4xl font-normal md:text-5xl lg:text-6xl'>
                  Select the type of{' '}
                ...
                <p className='md:text-md hidden w-full hyphens-none text-sm md:block'>
                ...
                <div className='flex flex-wrap gap-1 md:gap-4'>
                  ...
                  <a className='flex h-16 w-16 flex-col items-center justify-center rounded-2xl bg-white text-xs uppercase text-mytext-color shadow-lg transition duration-300 hover:-translate-y-1 hover:scale-110 hover:cursor-pointer md:h-24 md:w-24 lg:text-sm'>
            ...
            <div className='z-1 relative mx-auto mt-10 flex w-full flex-col items-center justify-center md:h-full md:w-2/4'>
              <div className='flex items-center justify-center rounded-lg bg-white bg-opacity-80 px-2 py-2 lg:px-4 lg:py-4'>
              ...
              <div className='hidden h-1/3 items-center justify-start text-left md:flex'>
                <a className='flex h-24 w-24 flex-col items-center justify-center rounded-lg bg-white bg-opacity-50 text-xs uppercase text-mytext-color shadow-lg transition duration-300 hover:-translate-y-1 hover:scale-110 hover:cursor-pointer lg:text-sm'>
              ...
              {/* <div className=' h-1/4 w-3/4 bg-white shadow-lg'></div> */}
            </div>
          </div>
        </section>
      </main>
