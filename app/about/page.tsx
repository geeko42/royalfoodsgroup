...
const About: NextPage = () => {
  return (
    ...
    <main className='flex flex-col items-center justify-between bg-gradient-to-r from-dark-color to-light-color'>
      ...
      {/* Leadership Section */}
      <section className='z-1 relative flex h-screen w-full items-center justify-center'>
        <div className='flex flex-col flex-wrap items-center justify-center lg:flex-row'>
          <div className='flex flex-col items-center justify-center gap-0 py-10 text-center md:gap-4'>
            <h1 className='text-primary-color text-center text-4xl font-normal md:text-left md:text-5xl'>
              Leadership{' '}
              <span className='text-secondary-color font-bold'>Team</span>
            </h1>
            ...
            <div className='mt-10 flex space-x-8'>
              <div>
                ...
                <div className='text-primary-color mt-4'>
          ...
          <div className='flex flex-col gap-4 text-center'>
            <div className='flex w-full flex-col justify-center gap-4 overflow-hidden'>
              <h1 className='text-primary-color text-center text-xl font-normal md:text-3xl xl:text-left'>
                Message from the{' '}
                <span className='bg-secondary-color rounded-lg px-2 font-bold text-mytext-color'>
                  CEO
                </span>
              </h1>
              <p className='text-md text-primary-color lg:text-xl'>
        ...
        <section className='body-font text-mytext-color'>
          ...
          <div className='container mx-auto flex flex-wrap px-5 py-24'>
            <div className='relative mx-auto flex pb-20 pt-10 sm:items-center md:w-2/3'>
              ...
              <div className='title-font z-1 bg-secondary-color relative mt-10 inline-flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full text-sm font-medium text-mytext-color sm:mt-0'>
                1
              </div>
              <div className='flex flex-grow flex-col items-start pl-6 sm:flex-row sm:items-center md:pl-8'>
                ...
                <div className='mt-6 flex-grow sm:mt-0 sm:pl-6'>
                  <p className='text-primary-color text-left leading-relaxed'>
                    Royal Foods launches its frozen food factory, one of the
                    first based in Rawat Industrial Estate generating employment
                    for 30 people
                  </p>
                </div>
              </div>
            ...
            <div className='relative mx-auto flex pb-20 pt-10 sm:items-center md:w-2/3'>
              ...
              <div className='flex flex-grow flex-col items-start pl-6 sm:flex-row sm:items-center md:pl-8'>
                ...
                <div className='mt-6 flex-grow sm:mt-0 sm:pl-6'>
                  <p className='text-primary-color text-left leading-relaxed'>
                    New management takes over with a vision to become the No. 1
